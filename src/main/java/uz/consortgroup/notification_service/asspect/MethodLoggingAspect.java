...
public class MethodLoggingAspect {
    ...
    @Before("@annotation(uz.consortgroup.notification_service.asspect.annotation.LoggingAspectBeforeMethod)")
    ...
    @After("@annotation(uz.consortgroup.notification_service.asspect.annotation.LoggingAspectAfterMethod)")
